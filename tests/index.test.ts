...
import { APIUserAbortError } from 'find-ai';
import { Headers } from 'find-ai/core';
...
describe('instantiate client', () => {
  ...
  test('normalized method', async () => {
    ...
    const client = new FindAI({ baseURL: 'http://localhost:5000/', apiKey: 'My API Key', fetch: testFetch });
  ...
  describe('baseUrl', () => {
    ...
    afterEach(() => {
      process.env['FIND_AI_BASE_URL'] = undefined;
    });
    ...
    test('in request options overridden by client options', () => {
      const client = new FindAI({ apiKey: 'My API Key', baseURL: 'http://localhost:5000/client' });
      expect(client.buildURL('/foo', null, 'http://localhost:5000/option')).toEqual(
    ...
    test('in request options overridden by env variable', () => {
      process.env['FIND_AI_BASE_URL'] = 'http://localhost:5000/env';
      const client = new FindAI({ apiKey: 'My API Key' });
      expect(client.buildURL('/foo', null, 'http://localhost:5000/option')).toEqual(
