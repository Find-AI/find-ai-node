...
export class FindAI extends Core.APIClient {
  ...
  constructor({
    ...
    super({
      ...
      baseURLOverridden: baseURL ? baseURL !== 'https://usefind.ai/found' : false,
    ...
    const customHeadersEnv = Core.readEnv('FIND_AI_CUSTOM_HEADERS');
    if (customHeadersEnv) {
  ...
  #baseURLOverridden(): boolean {
    return this.baseURL !== 'https://usefind.ai/found';
  }
  ...
  static FindAIError = Errors.FindAIError;
